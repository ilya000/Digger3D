...
//
// Everything the simulation and the 2D renderer need from the original 1983
// DIGGER program is described here. The extractor (tools/extract) produces
// `src/assets/original.ts`; until then `src/assets/standin.ts` (generated by
// `src/assets/gen-standin.mjs` from the Digger Remastered data) provides the same
// bundle. Core code depends only on these types.
//
...
export interface AssetBundle {
  /** Where the data came from, e.g. "original" or "standin". */
